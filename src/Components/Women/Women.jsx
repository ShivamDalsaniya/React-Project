...
function Women() {
  ...
  // Function to handle adding/removing items to/from wishlist
  ...
  //       .then(() => {
  //         setWishlist([...wishlist, item]); // Update wishlist state
  //       })
  //       .catch((error) => {
  //         console.error(
  ...
  //     axios
  //       .delete(`http://localhost:8000/wishlist/${item.id}`)
  //       .then(() => {
  //         setWishlist(
                  ...
                  {/* <div className="flex justify-center mt-2">
                    <span
                      className={`cursor-pointer text-2xl ${
                        isItemInWishlist(item) ? "text-red-500" : "text-black"
                      }`}
                      onClick={() => handleAddToWishlist(item)}
                    >
                      {isItemInWishlist(item) ? <FaHeart /> : <FaRegHeart />}
                    </span>
                  </div> */}
                </div>
              ))}
