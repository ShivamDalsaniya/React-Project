...
function Register() {
  ...
  const handleRegister = (e) => {
    ...
    if (validate()) {
      ...
      users.push(newUser); // Add new user to the array of users
      localStorage.setItem("users", JSON.stringify(users)); // Store updated users array back into local storage
